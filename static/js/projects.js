...
{'btnid': 1019, 'intro': 'coala provides a unified interface for linting and fixing code with a single configuration file, regardless of the programming languages used. You can use co...', 'link': 'https://github.com/coala/', 'id': 19, 'mentor_email': 'yash.nisar@somaiya.edu | code.rishus23@gmail.com', 'img': 'https://github.com/coala.png?size=50', 'title': 'COALA', 'tag': ['Python', 'code-analysis', 'linter', 'languages', 'generic'], 'mentor': 'Yash Nisar | Rishav Kumar', 'comm': 'https://gitter.im/coala/coala', 'intro_full': 'coala provides a unified interface for linting and fixing code with a single configuration file, regardless of the programming languages used. You can use coala from within your favorite editor, integrate it with your CI, get the results as JSON, or customize it to your needs with its flexible configuration syntax.  coala has a set of official bears (plugins) for several languages, including popular languages such as C/C++, Python, JavaScript, CSS, Java and many more, in addition to some generic language independent algorithms.'},
